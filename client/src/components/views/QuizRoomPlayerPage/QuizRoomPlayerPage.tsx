...
const QuizRoomPlayerPage = () => {
  ...
  const observers = [
    ...
    { name: "Donata", ID: "222333" },
    { name: "Rafał", ID: "222333" },
  ];
      ...
      <GameViewContainer>
        <FlexWrapper direction="column" align-items="center">
          ...
          <FlexWrapper direction="column">
            ...
            <AnswersContainer>
              {answers.map((answer) => (
                <Button background="answer">{answer}</Button>
              ))}
            </AnswersContainer>
            <FlexWrapper justifyContent="space-between">
              <Button background="true" hoverBackground="trueHover">
                Prawda
              </Button>
              <Button background="false" hoverBackground="falseHover">
                Fałsz
              </Button>
